...
function give_process_donation_form() {
	 ...
	 * @since 1.7
	 */
	$payment_data = apply_filters( 'give_donation_data_before_gateway', $payment_data, $valid_data );
	...
	give_send_to_gateway( $payment_data['gateway'], $payment_data );
	give_die();
